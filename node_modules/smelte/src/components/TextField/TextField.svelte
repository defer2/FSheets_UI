<script>
  ...
  export let forceBgColorWhite = false;
  export let forceTextColorBlack = false;
  ...
  $: iClasses = cb
      ...
      .add('bg-white', forceBgColorWhite)
      .remove('bg-gray-100', forceBgColorWhite)
      .remove('bg-gray-300', forceBgColorWhite)
      .add($$props.class)
      .remove(remove)
      .replace(replace)
      .extend(extend)
  ...
  $: wClasses = ccb.flush()
      ...
      .remove('text-gray-200', forceTextColorBlack)
      .remove('text-gray-600', forceTextColorBlack)
      .add('text-black', forceTextColorBlack)
      .get();
