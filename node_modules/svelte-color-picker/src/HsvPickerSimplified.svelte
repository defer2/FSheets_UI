...
<div class="main-container">
  ...
  <div class="colorsquare size" style="display:none;">
  ...
  <div class="alpha-selector" style="display:none;">
  ...
  <div class="color-info-box" style="display:none;">
    <div class="color-picked-bg">
      <div class="color-picked"></div>
    </div>

    <div class="hex-text-block" style="display:none;">
      <p class="text">{hexValue}</p>
    </div>

    <div class="rgb-text-div" style="display:none;">
      <div class="rgb-text-block">
        <p class="text">{r}</p>
        <p class="text-label">R</p>
      </div>

      <div class="rgb-text-block" style="display:none;">
        <p class="text">{g}</p>
